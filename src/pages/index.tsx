...
import { Alert, AlertDescription, AlertIcon, AlertTitle, Box, Button, Center, CloseButton, Flex, Heading, Spacer, Stack, StackDivider, Text, VStack } from "@chakra-ui/react";
		...
		<Nav>
			<Box minWidth="full" maxWidth="container.xl" h="full" mt={12}>
				...
				<Flex flexDirection={{ base: "column", sm: "column", md: "column", lg: "row" }} align="center" justify="space-between" w="full" mb={12}>
					...
					<Flex flexDirection="row" align="center" justify="space-between" rounded="md" bg="teal.300" p={3} minW={{ base: "100%", md: "50%" }} mt={{ base: 8, lg: 0 }}>
				...
				{/* Contenido y tablas */}
				<Stack direction={{ base: "column", lg: "row" }} mb={12} mt={12}>
					<VStack
